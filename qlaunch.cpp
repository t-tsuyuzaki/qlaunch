// qlaunch.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CqlaunchApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// CqlaunchApp コンストラクション

CqlaunchApp::CqlaunchApp()
{
