================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : qlaunch プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した qlaunch には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには qlaunch アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
qlaunch.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CqlaunchApp アプリケーション クラス
    の宣言をします。

qlaunch.cpp
    このファイルは CqlaunchApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\qlaunch.ico
    ...
    リソース ファイル qlaunch.rc によってインクルードされます。
...
qlaunchDlg.h, qlaunchDlg.cpp - the dialog
    Tこれらのファイルは CqlaunchDlg クラスを含みます。このクラスはアプリケーションの 
    メイン ダイアログの動作を定義します。ダイアログ テンプレートは Microsoft Visual C++ で編集 
    可能な qlaunch.rc に含まれます。
/////////////////////////////////////////////////////////////////////////////

その他の標準ファイル :

StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) qlaunch.pch や既にコン 
